...
Proof.
intros f H b.
rewrite H. rewrite H. rewrite negb_involutive. reflexivity. Qed.
...
Example test_un1: un BO  = 0.
Proof. simpl. reflexivity. Qed.

Example test_un2: un (BST BO)  = 1.
Proof. simpl. reflexivity. Qed.

Example test_un3: un (BS (BST BO))  = 2.
Proof. simpl. reflexivity. Qed.
