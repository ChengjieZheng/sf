...
Example e_op_b: beval (optimize_0plus_b (BEq (APlus (ANum 1) (ANum 2)) (APlus (ANum 1) (ANum 2))))  = beval BTrue.
Proof.
  reflexivity.
Qed.
...
- induction a.
  ...
  + unfold optimize_0plus_b. unfold beval. rewrite optimize_0plus_sound. rewrite optimize_0plus_sound. reflexivity.
  + unfold optimize_0plus_b. unfold beval. rewrite optimize_0plus_sound. rewrite optimize_0plus_sound. reflexivity.
  +  unfold optimize_0plus_b. unfold beval. rewrite optimize_0plus_sound. rewrite optimize_0plus_sound. reflexivity.
- induction a.
  +  unfold optimize_0plus_b. unfold beval. rewrite optimize_0plus_sound. rewrite optimize_0plus_sound. reflexivity.
...
try (induction a;
     ...
     try (unfold optimize_0plus_b; unfold beval; rewrite optimize_0plus_sound; rewrite optimize_0plus_sound; reflexivity)
    ).
Qed.
(** [] *)
